model A3
  ...
  Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage(V = 200, freqHz = 60) annotation(
...
equation
  ...
  connect(sineVoltage.n, ground1.p) annotation(
    Line(points = {{-80, 20}, {-80, -2}}, color = {0, 0, 255}));
  connect(sineVoltage.p, vierqst1.p1) annotation(
    Line(points = {{-80, 40}, {-14, 40}}, color = {0, 0, 255}));
  connect(sineVoltage.n, vierqst1.n1) annotation(
